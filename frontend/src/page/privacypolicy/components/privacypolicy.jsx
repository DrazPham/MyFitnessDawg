        ...
        <div className="container">
          <div id="en" className="tab-content translations-content-item en visible">
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Website</strong>&nbsp;refers to MyFitnessDawg,
                  accessible from&nbsp;
                  <a
                    href="https://astronomyx.space/"
                    target="_blank"
                    rel="external nofollow noopener"
                  >
                    https://astronomyX.space
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>By email:&nbsp;drazpham08@gmail.com</p>
              </li>
              <li>
                <p>By phone number: 0981932089</p>
              </li>
            </ul>
          </div>
        </div>
